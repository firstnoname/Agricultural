            ...
            try {
                ...
                if (idxEngine.equals("0")) {
                    data = URLEncoder.encode("idNo", "UTF-8") + "=" + URLEncoder.encode(idNo, "UTF-8") + "&" +
                            ...
                            URLEncoder.encode("carburetor", "UTF-8") + "=" + URLEncoder.encode(partName[4].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("cylinderSet", "UTF-8") + "=" + URLEncoder.encode(partName[5].replace("\"","").trim(), "UTF-8") + "&" +
                            ...
                            URLEncoder.encode("switchOnOff", "UTF-8") + "=" + URLEncoder.encode(partName[8].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("coil", "UTF-8") + "=" + URLEncoder.encode(partName[9].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("fuelTankCap", "UTF-8") + "=" + URLEncoder.encode(partName[10].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("newPaint", "UTF-8") + "=" + URLEncoder.encode(partName[11].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("oilTankCap", "UTF-8") + "=" + URLEncoder.encode(partName[12].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("sparkPlug", "UTF-8") + "=" + URLEncoder.encode(partName[13].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("amount", "UTF-8") + "=" + URLEncoder.encode(amount, "UTF-8") + "&" +
                    ...
                    data = URLEncoder.encode("idNo", "UTF-8") + "=" + URLEncoder.encode(idNo, "UTF-8") + "&" +
                            ...
                            URLEncoder.encode("fuelTank", "UTF-8") + "=" + URLEncoder.encode(partName[2].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("airFilter", "UTF-8") + "=" + URLEncoder.encode(partName[3].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("carburetor", "UTF-8") + "=" + URLEncoder.encode("", "UTF-8") + "&" +
                            URLEncoder.encode("cylinderSet", "UTF-8") + "=" + URLEncoder.encode("", "UTF-8") + "&" +
                            URLEncoder.encode("ballValveSwitchOil", "UTF-8") + "=" + URLEncoder.encode("", "UTF-8") + "&" +
                            URLEncoder.encode("muffler", "UTF-8") + "=" + URLEncoder.encode(partName[4].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("switchOnOff", "UTF-8") + "=" + URLEncoder.encode(partName[5].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("coil", "UTF-8") + "=" + URLEncoder.encode("", "UTF-8") + "&" +
                            URLEncoder.encode("fuelTankCap", "UTF-8") + "=" + URLEncoder.encode(partName[6].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("newPaint", "UTF-8") + "=" + URLEncoder.encode(partName[7].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("oilTankCap", "UTF-8") + "=" + URLEncoder.encode(partName[8].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("sparkPlug", "UTF-8") + "=" + URLEncoder.encode(partName[9].replace("\"","").trim(), "UTF-8") + "&" +
                            URLEncoder.encode("amount", "UTF-8") + "=" + URLEncoder.encode(amount, "UTF-8") + "&" +
                            URLEncoder.encode("dealingStatus", "UTF-8") + "=" + URLEncoder.encode(dealingStatus, "UTF-8");
                    System.out.println("idxEngine = ไม่ติด " + idxEngine);
                    System.out.println("data = " + data);

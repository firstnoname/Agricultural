...
public class SubmitEstimateG200 extends AppCompatActivity {
    ...
    private void calculatePrice() {
        ...
        if (idxEngine == 0) {
            ...
            //Estimate price.
            dAmount = Double.parseDouble(preEstimatedPrice)*0.5 - (dStarter + dFuelTank + dAirFilter + dCarburetor +
                    dCylinderSet + dBallValveSwitchOil + dMuffler + dSwitchOnOff + dCoil + dFuelTankCap +
                    dNewPaint + dOilTankCap + dSparkPlug);
            ...
            //Estimate price.
            dAmount = Double.parseDouble(preEstimatedPrice)*0.3 - (dStarter + dFuelTank + dAirFilter +
...
//        idxEngine = getIntent().getIntExtra("idxEngine",0);
        ...
        System.out.println(idSelectedList);
    ...
    public void intentSaveG200(View view) {
        ...
        Intent intentSaveG200 = new Intent(this, BuyEstimatedG200.class);
    ...
    public void intentBuyG200(View view) {
        ...
        Intent intentBuyG200 = new Intent(this, BuyEstimatedG200.class);
